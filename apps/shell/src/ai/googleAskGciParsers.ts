...
// Drive / Calendar read-only actions. Gmail parser (parseGmailSearchCommand)
// and IMPORTANT_EMAILS_RE removed — final product decision: GCI/GIA no
// longer reads email at all. Pure functions, no side effects.
