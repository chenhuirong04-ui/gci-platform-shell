...
export const AI_CAPABILITY_MAP: AIIntent[] = [
  ...
  // ── 3. Check Follow-ups ────────────────────────────────────────────────────
  {
    ...
    targetTab: 'chat',
    targetModule: 'CRM',
    targetRoute: '/crm-customers',
    readSources: ['crm_customers (Supabase CRM)', 'crm_followups (Supabase CRM)'],
    writeTargets: [],
    requiredFields: [],
    approvalRequired: false,
    resultPanel: null,
    implementationStatus: 'missing',
    notConnectedMessage: '客户跟进数据在 CRM 客户库（Supabase）。\n\n请直接前往 CRM → 客户与项目 查看今日跟进清单。',
    fallbackBehavior: '显示"未连接"提示，引导用户前往 /crm-customers 查看真实数据。',
  },
  ...
  // ── 5. Create Customer Draft ───────────────────────────────────────────────
  {
    ...
    targetModule: 'CRM',
    targetRoute: '/crm-customers',
    readSources: ['crm_customers (Supabase CRM)'],
    writeTargets: ['crm_customers', 'crm_contacts'],
    requiredFields: ['clientName', 'phoneE164 or email', 'goal'],
    approvalRequired: true,
    resultPanel: null,
    implementationStatus: 'missing',
    notConnectedMessage: '客户档案在 CRM 客户库（Supabase）。\n\n请前往 CRM → 客户与项目 新增客户。',
    fallbackBehavior: '显示"未连接"提示，引导用户前往 /crm-customers 新增客户。',
  },
  ...
  // ── 7. Generate Daily Brief ────────────────────────────────────────────────
  {
    ...
    readSources: [
      'crm_customers (Supabase CRM follow-ups)',
