...
function CrmInner({ initialTab, demoMode = false }: { initialTab?: CrmTab; demoMode?: boolean }) {
  ...
  const handleAddTask = async (formData: Partial<FollowUpTask>) => {
    ...
    const baseTask: FollowUpTask = {
      ...
      // Formal project/business code, generated by the caller (see
      // CustomerWorkspaceBody's inline "新增业务" form) before invoking this
      // function — passed through untouched, never fabricated here.
      projectCode: (formData as any).projectCode,
    };
