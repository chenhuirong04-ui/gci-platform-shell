    ...
    >
      ...
      <div className="flex items-center" style={{ gap: 18 }}>
        <div
          ...
          style={{ gap: 7, width: 200, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 8, padding: '7px 12px' }}
        >
          <span style={{ color: '#4A5268', fontSize: 13 }}>⌕</span>
          <span style={{ fontSize: 12, color: '#4A5268' }}>{searchPlaceholder}</span>
        </div>
        <div className="flex items-center" style={{ gap: 6 }}>
          <span style={{ width: 6, height: 6, borderRadius: '50%', background: colors.statusSuccess, animation: 'pulse 3s ease infinite' }} />
